...
class ExportScanResultsJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(ExportService $exportService, ActivityLogService $activityLog): void
    {
        ...
        $exportRequest = $exportService->generateQueuedScanResultsExport($exportRequest);
    ...
    public function failed(?Throwable $exception): void
    {
        ...
        Log::error('Queued scan export failed', [
        ...
        app(ActivityLogService::class)->record(
            user: $exportRequest?->user,
            action: 'export.scan_results.job_failed',
            subject: $exportRequest,
            metadata: [
                'format' => $exportRequest?->format,
                'filters' => $exportRequest?->filters,
