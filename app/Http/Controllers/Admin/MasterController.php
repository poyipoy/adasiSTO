...
class MasterController extends Controller
{
    ...
    public function locationData(Request $request): JsonResponse
    {
        ...
        if ($request->filled('pic')) {
            $query->where('created_by_user_id', $request->pic);
        }
        ...
        return $this->dataTable(
            ...
            fn(Location $location, int $no) => [
                ...
                'id' => $location->id,
                'name' => $location->name,
                'old_location_name' => $location->old_location_name ?? '-',
        ...
        $configs = [
            ...
            'location' => [
                ...
                'columns' => [
                    ...
                    ['data' => 'old_location_name', 'label' => 'Old Location Name'],
                    ['data' => 'description', 'label' => 'Description'],
                    ['data' => 'warehouse', 'label' => 'Warehouse'],
                    ['data' => 'plant', 'label' => 'Plant', 'field' => 'plant_id'],
                    ['data' => 'pic', 'label' => 'PIC'],
                ...
                'filters' => [
                    ...
                    [
                        ...
                        'label' => 'Warehouse',
                        'type' => 'select',
                        'options' => Location::whereNotNull('warehouse')->where('warehouse', '!=', '')->distinct()->orderBy('warehouse')->pluck('warehouse')->map(fn($w) => ['value' => $w, 'label' => $w])->toArray()
                    ],
                    [
                        'name' => 'pic',
                        'label' => 'PIC',
                        'type' => 'select',
                        'options' => User::orderBy('name')->get()->map(fn($u) => ['value' => $u->id, 'label' => $u->name])->toArray()
                    ],
                    [
                        'name' => 'is_active',
                        'label' => 'Status',
