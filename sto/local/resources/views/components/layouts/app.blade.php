...
<head>
    ...
    <link href="{{ asset('vendor/boxicons/boxicons.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            ...
            <form id="logoutForm" method="POST" action="{{ route('logout') }}" style="margin:0;display:flex;">
                @csrf
                    ...
                    <div class="sidebar-section-items">
                        ...
                        <a href="{{ route('admin.rack-confirmation') }}"
                            ...
                            @if(($sidebarBadges['unconfirmed_rak'] ?? 0) > 0)
                                <span class="sidebar-counter" style="background: #e63946;">{{ $sidebarBadges['unconfirmed_rak'] }}</span>
                            @endif
                        </a>
