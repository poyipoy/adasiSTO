...
<div class="modal-overlay" id="duplicateDetailModal">
    <div class="modal-content material-double-modal">
        ...
        <div class="modal-footer">
            ...
            <button id="deleteSelectedDuplicateBtn" class="btn btn-danger" type="button" onclick="deleteSelectedDuplicateRows()">Delete Selected</button>
        </div>
    </div>
</div>
...
<div class="modal-overlay" id="materialDoubleScanModal">
    <div class="modal-content material-double-scan-modal">
        ...
        <div class="modal-body">
            ...
            <div class="scan-header" style="display:flex;justify-content:space-between;gap:8px;align-items:center;margin:10px 0;">
                <div class="scanner-mode-toggle" role="group" aria-label="Scanner Mode">
                    <button type="button" id="materialDoubleAutoScanModeBtn" class="active" onclick="setMaterialDoubleScannerMode('auto')">Auto Scan</button>
                    <button type="button" id="materialDoubleSelectBarcodeModeBtn" onclick="setMaterialDoubleScannerMode('select')">Select Barcode</button>
                </div>
                <div class="camera-buttons" style="display:flex;gap:6px;">
                    <button class="btn" type="button" id="showMaterialDoubleCameraBtn" onclick="showMaterialDoubleScanCamera()">Show Camera</button>
                    <button class="btn" type="button" id="hideMaterialDoubleCameraBtn" onclick="hideMaterialDoubleScanCamera()" style="display:none;">Hide Camera</button>
                </div>
            </div>
            <div id="materialDoubleScanReaderWrap" style="display:none;margin-bottom:10px;">
                <div id="materialDoubleScanReader" style="min-height:220px;border:1px solid var(--border);background:#fafbfc;"></div>
            </div>
            <div class="form-group">
                <label class="form-label" for="materialDoubleScanQr">QR Final</label>
                <input id="materialDoubleScanQr" class="form-control mono" placeholder="Masukkan QR Code" autocomplete="off">
            </div>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="submitMaterialDoubleScan(false)">Simpan Scan</button>
        </div>
    </div>
</div>
