<x-layouts.app :title="'Generate Barcode'">
    ...
    <div class="enterprise-toolbar">
        ...
        <button class="btn btn-outline-primary" type="button" id="btnBatchGenerate" onclick="bulkGenerate()"
            title="Klik untuk info: Belum ada data Pending yang dipilih/ceklis">
            Generate Terpilih (Batch)
        </button>
        <button class="btn btn-outline-primary" type="button" id="btnBulkPrint" onclick="bulkPrint()"
            title="Klik untuk info: Belum ada data Approved yang dipilih/ceklis">
        ...
        <button class="btn btn-outline-success" type="button" id="btnBulkPrintXlsx" onclick="bulkPrintXlsx()"
            title="Unduh label Approved ke format Excel (.xlsx)">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                style="width:14px;height:14px;vertical-align:middle;margin-right:3px;">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <button class="btn btn-outline-secondary" type="button" id="btnBulkPrintGrid" onclick="bulkPrintGrid()"
            title="Klik untuk info: Belum ada data Approved yang dipilih/ceklis">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                style="width:14px;height:14px;vertical-align:middle;margin-right:3px;">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="modal-overlay" id="generateModal">
        <div class="modal-content" style="max-width:420px;">
            ...
            <div class="modal-body">
                <div id="generateModalInfo"
                    style="background:#f4f8ff;border:1px solid #c3d6f7;padding:10px;margin-bottom:12px;font-size:12px;">
                </div>
                <div class="form-group">
                    <label class="form-label" for="inputQty">Qty (pcs)</label>
                    <input type="number" id="inputQty" class="form-control" value="1" readonly
                        style="background: var(--bg-secondary); cursor: not-allowed; font-weight: 700; color: var(--primary);">
                </div>
                <div id="generateModalError" style="display:none;color:var(--danger);font-size:12px;margin-top:6px;">
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-overlay" id="rejectModal">
        <div class="modal-content" style="max-width:420px;">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" for="inputRejectReason">Alasan Penolakan <span
                            style="color:var(--danger);">*</span></label>
                    <textarea id="inputRejectReason" class="form-control" rows="3"
                        placeholder="Wajib diisi (min. 5 karakter)" style="resize:vertical;"></textarea>
                </div>
                <div id="rejectModalError" style="display:none;color:var(--danger);font-size:12px;margin-top:6px;">
                </div>
            </div>
            <div class="modal-footer">
