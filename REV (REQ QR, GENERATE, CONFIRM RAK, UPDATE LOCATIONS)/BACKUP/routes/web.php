...
Route::middleware(['auth', 'role:admin'])
    ...
    ->group(function () {
        ...
        // Master Location (Lokasi Rak yang dikelola Admin)
        Route::get('/master-location', [MasterController::class, 'locations'])->name('master-location');
        Route::get('/api/master-location', [MasterController::class, 'locationData'])->middleware('throttle:datatable')->name('api.master-location');
        Route::post('/api/master-location', [MasterController::class, 'storeLocation'])->name('api.master-location.store');
        Route::put('/api/master-location/{id}', [MasterController::class, 'updateLocation'])->name('api.master-location.update');
        Route::delete('/api/master-location/{id}', [MasterController::class, 'destroyLocation'])->name('api.master-location.destroy');
        ...
        Route::post('/api/generate-barcode/store', [GenerateBarcodeController::class, 'store'])
            ->middleware('throttle:scan-write')
            ->name('api.generate-barcode.store');
        Route::get('/api/generate-barcode/locations-by-plant', [GenerateBarcodeController::class, 'locationsByPlant'])
            ->name('api.generate-barcode.locations-by-plant');
