<x-layouts.app :title="'Scanner'">
    ...
    <div class="card" style="margin-bottom:12px;">
        ...
        <div class="form-group">
            ...
            <div id="debugRawOutput" style="display: none; font-family: monospace; font-size: 11px; color: red; margin-top: 4px;"></div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function submitScan(forceSave = false, qrText = null, source = 'manual') {
                ...
                // Hanya trim dan hapus trailing pipe. JANGAN replace spasi panjang 
                // agar backend bisa mendeteksi dan menolak format lama.
                qr = qr.trim();
                qr = qr.replace(/\|$/, '').trim();
