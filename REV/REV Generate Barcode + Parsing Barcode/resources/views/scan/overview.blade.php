...
<div class="enterprise-toolbar" style="margin-bottom: 16px; display: flex; justify-content: flex-end;">
    <button class="btn" style="border-radius:50px; background:var(--bg-color); border:1px solid var(--border); color:var(--text);" type="button" onclick="refreshScannerOverview()">
...
<div class="overview-grid">
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-value" data-card="duplicate_scans">{{ number_format($scanOverview['duplicate_scans']) }}</div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-value" data-card="invalid_scans">{{ number_format($scanOverview['invalid_scans']) }}</div>
    </div>
...
@if($validatorOverview)
    <div style="margin-top:24px; margin-bottom: 16px; font-size: 18px; font-weight: 700; color: var(--text);"><i class='bx bx-check-double' style="margin-right: 6px; color: var(--primary);"></i> Validator Overview</div>
    <div class="overview-grid">
        <div class="stat-card">
            <div class="stat-icon" style="background: rgba(0, 114, 206, 0.1); color: var(--primary);">
            ...
            <div class="stat-card-value" data-validator-card="total_barcode">{{ number_format($validatorOverview['total_barcode']) }}</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background: rgba(34, 160, 107, 0.1); color: var(--success);">
            ...
            <div class="stat-card-value" data-validator-card="valid">{{ number_format($validatorOverview['valid']) }}</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background: rgba(229, 161, 0, 0.1); color: var(--warning);">
            ...
            <div class="stat-card-value" data-validator-card="need_check">{{ number_format($validatorOverview['need_check']) }}</div>
        </div>
    </div>
@endif
...
<div class="dashboard-grid">
    <div class="card">
        <div class="card-title"><i class='bx bx-calendar' style="margin-right: 8px; color: var(--primary);"></i> Scan per Day</div>
    ...
    @if($validatorOverview)
        <div class="card">
            <div class="card-title"><i class='bx bx-check-shield' style="margin-right: 8px; color: var(--success);"></i> Validation by Validator</div>
