...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .adasi-modal-header .icon {
            font-size: 20px;
            line-height: 1;
            flex-shrink: 0;
        }

        .adasi-modal-header .title {
            font-size: 15px;
            font-weight: 600;
        ...
        .adasi-modal-footer .btn + .btn::before {
            content: "";
            position: absolute;
            left: 0;
            top: 8px;
...
<body>
            ...
            @if(auth()->user()->isAdmin())
                ...
                <div class="nav-section">
                    ...
                    <a href="{{ route('admin.scan-results') }}"
                        class="nav-link {{ request()->routeIs('admin.scan-results*') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ route('admin.barcode-overview') }}"
                        class="nav-link {{ request()->routeIs('admin.barcode-overview*') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="nav-section">
                    ...
                    <a href="{{ route('admin.master.plants') }}"
                        class="nav-link {{ request()->routeIs('admin.master.plants') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ route('admin.master.materials') }}"
                        class="nav-link {{ request()->routeIs('admin.master.materials') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ route('admin.master.keterangan') }}"
                        class="nav-link {{ request()->routeIs('admin.master.keterangan') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @else
                <div class="nav-section">
                    ...
                    <a href="{{ route('scan.setup') }}"
                        class="nav-link {{ request()->routeIs('scan.setup') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ route('scan.results') }}"
                        class="nav-link {{ request()->routeIs('scan.results') ? 'active' : '' }}">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div id="sidebarOverlay" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.5); z-index:45;"
    ...
    <script>
        ...
        function adasiAlert(options) {
            ...
            if (type === 'confirm') {
                ...
                // Auto close after 1.3s for non-confirm alerts
                setTimeout(() => closeDialog(), 1300);
            }
        }

        // Redirect old showToast
        function showToast(message, type = 'success') {
            adasiAlert({
                type: type, // maps 'success' or 'error'
                message: message
            });
        }

        // Redirect old confirmAction
